...
class Navigation extends Component {
    ...
    loginCheck = async () => {
        ...
        if (loggedIn) {
            ...
            this.setState({ loginForm: false, authorized: true, error: false, wishes: wishes });
            console.log(wishes);
        } else {
            ...
            <div className="grid top-nav">
                ...
                <nav>
                    <ul className="nav-header">
                        ...
                        >
                            <div className="authorize-popup">
                                <div className="authorize-content">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="for test type admin"
                                        onChange={e => {
                        ...
                        {this.state.authorized && <li>
                            <Link to={process.env.PUBLIC_URL + "/User"}>User</Link>
                        </li>}
                    </ul>
                </nav>
            </div>
